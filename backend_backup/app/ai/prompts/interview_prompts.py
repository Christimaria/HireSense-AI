...
ROLE_CONTEXT = {
    ...
    "Frontend Developer": "HTML, CSS, JavaScript, React/Vue, browser APIs, performance, accessibility, responsive design",
    "Backend Developer": "REST APIs, databases, server architecture, caching, authentication, microservices",
    "Full Stack Developer": "frontend frameworks, backend services, databases, deployment, full product ownership",
    ...
    "DevOps Engineer": "CI/CD pipelines, Docker, Kubernetes, cloud infrastructure, monitoring, IaC, SRE practices",
    "Cybersecurity Analyst": "threat analysis, penetration testing, SIEM, incident response, network security, compliance",
    "HR Interview": "company culture, team fit, communication, conflict resolution, motivation, career goals",
}
